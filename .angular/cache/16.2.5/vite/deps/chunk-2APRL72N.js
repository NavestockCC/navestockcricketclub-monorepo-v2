...
function computed(computation, options) {
  ...
  (options == null ? void 0 : options.equal) && (node.equal = options.equal);
  const computed2 = () => {
...
function afterRender(callback, options) {
  ...
  let destroy;
  const unregisterFn = injector.get(DestroyRef).onDestroy(() => destroy == null ? void 0 : destroy());
...
var _AfterRenderEventManager = class _AfterRenderEventManager {
  ...
  begin() {
    var _a;
    (_a = this.handler) == null ? void 0 : _a.validateBegin();
    this.renderDepth++;
  }
  /**
...
function commitLViewConsumerIfHasProducers(lView, slot) {
  ...
  if (!((_a = consumer.producerNode) == null ? void 0 : _a.length)) {
    return;
  }
...
function getOrCreateCurrentLViewConsumer() {
  currentConsumer ?? (currentConsumer = createLViewConsumer());
...
function detectChangesInternal(tView, lView, context, notifyErrorHandler = true) {
  ...
  if (!checkNoChangesMode) {
    ...
    afterRenderEventManager == null ? void 0 : afterRenderEventManager.begin();
  }
  try {
    ...
    if (!checkNoChangesMode) {
      ...
      (_c = environment.effectManager) == null ? void 0 : _c.flush();
      afterRenderEventManager == null ? void 0 : afterRenderEventManager.end();
    }
  }
}
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context, options) {
  ...
  const embeddedLView = createLView(declarationLView, embeddedTView, context, viewFlags, null, templateTNode, null, null, null, (options == null ? void 0 : options.injector) ?? null, (options == null ? void 0 : options.hydrationInfo) ?? null);
...
function handleProviderConfiguredEvent(context, data) {
  ...
  const diResolver = getDIResolver(context == null ? void 0 : context.injector);
  if (diResolver === null) {
...
function getDependenciesFromInjectable(injector, token) {
  ...
  let dependencies = ((_b = (_a = resolverToTokenToDependencies.get(diResolver)) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a, token)) ?? [];
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2APRL72N.js.map
