...
function flattenInherited(pathFromRoot) {
  return pathFromRoot.reduce((res, curr) => {
    ...
    const resolve = {
      ...curr.data,
      ...res.resolve,
      ...(_a = curr.routeConfig) == null ? void 0 : _a.data,
      ...curr._resolvedData
    };
    return {
      params,
...
var _Router = class _Router {
  ...
  get browserPageId() {
    ...
    return ((_a = this.location.getState()) == null ? void 0 : _a.ɵrouterPageId) ?? this.currentPageId;
  }
  /**
  ...
  restoreHistory(transition, restoringFromCaughtError = false) {
    ...
    if (this.canceledNavigationResolution === "computed") {
      ...
      } else if (this.currentUrlTree === ((_a = this.getCurrentNavigation()) == null ? void 0 : _a.finalUrl) && targetPagePosition === 0) {
...
var _RouterModule = class _RouterModule {
  ...
  static forRoot(routes, config) {
    return {
      ...
      }, (config == null ? void 0 : config.useHash) ? provideHashLocationStrategy() : providePathLocationStrategy(), provideRouterScroller(), (config == null ? void 0 : config.preloadingStrategy) ? withPreloading(config.preloadingStrategy).ɵproviders : [], {
        provide: NgProbeToken,
        multi: true,
        useFactory: routerNgProbeToken
      }, (config == null ? void 0 : config.initialNavigation) ? provideInitialNavigation(config) : [], (config == null ? void 0 : config.bindToComponentInputs) ? withComponentInputBinding().ɵproviders : [], provideRouterInitializer()]
    };
  }
  /**
